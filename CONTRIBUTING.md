...
- Make sure to include all relevant information, such as:
  ...
  - Which version of GNU grep are you comparing with?
...
grep should be very reliable. This means that we should never `panic!`.
...
just like the GNU grep. For example, paths on Linux might not be valid
